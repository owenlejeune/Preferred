...
/**
 * Implementation of {@link SwitchPreference} with the ability to add listeners for preference
 * changes, as well as auto-commit when the preference value changes
 */
@SuppressWarnings("unused")
public class PreferredSwitchPreference extends SwitchPreference {

    private List<PreferredChangeListener> listeners;

    public PreferredSwitchPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init(attrs);
    }

    public PreferredSwitchPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    public PreferredSwitchPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
